...
\noindent
Pokud se uživatel v~době své blokace pokusí přihlásit znovu, doba k jeho nejbližšímu přihlášení se aktualizuje na náhodnou dobu v~intervalu <10,~30>~sekund. Všechny hodnoty v tabulce~\ref{tab:allowed_num_of_repeatings} jsou pouze orientační a~je vhodné je optimalizovat tak, aby byl \textit{správně odhalen} automatický přístup, ale také tak, aby \textit{nebyl zablokován}normální uživatel.
