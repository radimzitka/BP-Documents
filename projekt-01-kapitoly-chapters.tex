...
\begin{table}[htbp]
\begin{tabularx}{\linewidth}{
  |>{\hsize=0.5\hsize}X|% Socialni sit
  >{\hsize=1.6\hsize}X|% Prvni akce
  >{\hsize=0.5\hsize}X|% Cas 1
  >{\hsize=1.6\hsize}X|% Druha akce
  >{\hsize=0.5\hsize}X|% Cas 2
...
\subsection*{Automatický test opakovaných přístupů}
